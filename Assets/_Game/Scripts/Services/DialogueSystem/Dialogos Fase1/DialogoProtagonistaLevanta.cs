...
public class DialogoProtagonistaLevanta : FluentScript
{
    ...
    public override FluentNode Create()
    {
        return
            Show() *
            Write("Acho que já estou melhor. Então, o que você estava dizendo...").WaitForButton() *
            ...
            Write("(Trigger de input para escrever o nome)").WaitForButton() *
            ...
            Options
            (
            Option("Juntar-se a causa dos Legisladores") *
                Write("É uma causa nobre, conte comigo na luta. Eles destruiram minha vila também...").WaitForButton() *
                Write("Pirin:\nÉ reconfortante saber que posso contar com a ajuda de quem derrotou o General Labahn.").WaitForButton() *
                ...
                Option("Aceitar o trabalho de maneira profissional") *
                Write("Eu aceito o trabalho, também tenho motivos pra ir ao Reino do Sul. O Dragg tinha viajado pra lá não faz muito tempo").WaitForButton() *
                Write("Pirin:\nÉ reconfortante saber que posso contar com a ajuda de quem derrotou o General Labahn.").WaitForButton() *
                Write("Pirin:\nBom, assim que estiver pronto, me espere na saída da vila. Vou terminar de tratar os pacientes e recolher meus pertences e te encontro lá").WaitForButton() *
                Hide() *
                End()
