...
namespace _Game.Scripts.Utils.MyBox.Attributes
{
    ...
    {
        const string TYPE_ERROR = "SearchableEnum can only be used on enum fields.";
    ...
    public class SearchablePopup : PopupWindowContent
    {
        ...
        const float ROW_INDENT = 8.0f;

        /// <summary> Name to use for the text field for search. </summary>
        const string SEARCH_CONTROL_NAME = "EnumSearchText";
        ...
        static readonly GUIStyle SearchBox = "ToolbarSearchTextField";
        static readonly GUIStyle CancelButton = "ToolbarSearchCancelButton";
        static readonly GUIStyle DisabledCancelButton = "ToolbarSearchCancelButtonEmpty";
