...
namespace _Game.Scripts.Utils.MyBox.Attributes
{
    ...
    public class SpriteLayerAttributeDrawer : PropertyDrawer
    {
        ...
        void HandleSpriteLayerSelectionUI(
            Rect position, SerializedProperty property, GUIContent label, string[] spriteLayerNames
        )
        {
        ...
        bool TryGetSpriteLayerIndexFromProperty(out int index, string[] spriteLayerNames, SerializedProperty property)
        {
