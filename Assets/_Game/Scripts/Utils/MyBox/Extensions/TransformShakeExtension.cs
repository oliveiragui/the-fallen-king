...
namespace _Game.Scripts.Utils.MyBox.Extensions
{
	...
	public static class TransformShakeExtension
    {
	    ...
	    /// </summary>
	    static Dictionary<Transform, Tuple<Coroutine, Vector3>> _activeShakingTransforms;
	    ...
	    public static void StartShake(
            this Transform transform, float time = 0.1f, float shakeBounds = 0.1f, bool useUnscaledTime = true,
        ...
        static IEnumerator TransformShakeCoroutine(
            Transform transform, float shakeTime, float bounds, bool useUnscaledTime, bool fadeBounds
        )
        {
        ...
        static void BreakShakeIfAny(Transform transform)
        {
