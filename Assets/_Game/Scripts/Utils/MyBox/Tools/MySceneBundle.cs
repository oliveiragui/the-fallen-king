...
namespace Utils.MyBox.Tools
{
    ...
    public static class MySceneBundle
    {
        ...
        static SceneBundle currentSceneBundle;
        static SceneBundle nextSceneBundle;
        ...
        static void PrepareSceneBundleForNextSceneByTransferOptions(Scene unloadedScene)
        {
    ...
    internal class SceneBundle
    {
        ...
        internal Bundle<string> StringData { get; }

        internal Bundle<float> FloatData { get; }

        internal Bundle<int> IntData { get; }

        internal Bundle<bool> BoolData { get; }

        internal Bundle<object> ObjectData { get; }
    }

    internal class Bundle<T>
    {
        readonly Dictionary<string, T> bundleData;
