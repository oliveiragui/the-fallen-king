...
namespace Utils.MyBox.Attributes
{
    ...
    {
        ButtonMethodHandler _buttonMethods;
        DisplayInspectorAttribute _instance;
        DisplayInspectorAttribute Instance => _instance ?? (_instance = attribute as DisplayInspectorAttribute);
        ...
        void DrawColouredRect(Rect rect, Color color)
        {
